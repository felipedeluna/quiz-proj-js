...
function render(quiz) {
    ...
    document
        .getElementById("container-pagina-inicial")
    ...
    document
        .getElementById("container-javascript")
        .classList.add("display-none");
    ...
    btn.addEventListener("click", () => {
        ...
        if (respostas_foram_respondidas(quiz)) {
            ...
            const respostasCliente = [
                ...
                document.querySelector('input[name="pergunta10"]:checked')
                    .value,
            ];
            for (let i = 0; i < 10; i++) {
            ...
            alert(
                "Por favor, responda todas as perguntas antes de concluir o quiz."
            );
        }
    });
});
